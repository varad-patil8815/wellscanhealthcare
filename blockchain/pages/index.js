...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Button primary size="huge" inverted>
      <Link route="/dashboard" className="item">
        Get Started
      </Link>
          ...
          >
            <Menu size="large" inverted>
              ...
              <Menu.Menu position="right">
                ...
                <Link route="/list" className="item">
                  Records List
                </Link>
                ...
                <Dropdown item text="Doctor">
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item>
                      <Link route="/diagnosis" style={{ color: "black" }}>
                        Diagnosis
                      </Link>
                    </Dropdown.Item>
                  </Dropdown.Menu>
          ...
          >
            ...
            <Dropdown item text="Patient">
              <Dropdown.Menu>
                ...
                <Dropdown.Item>
                  <Link route="/available-doctors" style={{ color: "black" }}>
                    Available Doctors
                  </Link>
                </Dropdown.Item>
                <Dropdown.Item>
            ...
            <Dropdown item text="Register">
              <Dropdown.Menu>
                <Dropdown.Item>
                  <Link route="/doctor-registration" style={{ color: "black" }}>
                    Doctor
                  </Link>
                </Dropdown.Item>
                <Dropdown.Item>
